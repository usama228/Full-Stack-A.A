...
export default withAuth(Installers);

function MyInstallers() {
    const auth = useAuth();
                                                ...
                                                (user.getAllUsers.users || []).map((item, i) => {
                                                    return (
                                                        <tr key={i}>
                                                            ...
                                                            <td className="vam">
                                                                <span className="fz14 fw400">{item.Installer?.experience || 'N/A'}</span>
                                                            </td>
                                                            <td className="vam">
                                                            ...
                                                            <td>
                                                                <div className="d-flex profile-content gap-1">
                                                                    <Link
                                                                        ...
                                                                        href={`/dashboard/projects/installer/${item.Installer?.id }`}>
                                                                        <span className="fa-solid fa-list text-thm2" />
                                                                    </Link>
                                                                    <Link
                                                                        data-tooltip-id="edit-tooltip"
                                                                        className="tag-delt text-thm2 "
                                                                        href={`/dashboard/installers/${item.id}`}>
                                                                        <span className="flaticon-pencil text-thm2" />
                                                                    </Link>
                                                                    <Link
                                                                        data-tooltip-id="add-tooltip"
                                                                        className="tag-delt text-thm2"
                                                                        href={`/dashboard/projects/${item.Installer?.id || 'N/A'}/new`}>
                                                                        <span className="fas fa-plus text-thm2" />
                                                                    </Link>
                                                                    <ReactTooltip
                                                                        id="products-tooltip"
                                                                        place="bottom"
                                                                        content="List of All Projects"
                                                                    />
                                                                    <ReactTooltip
                                                                        id="edit-tooltip"
                                                                        place="bottom"
                                                                        content="Edit Installer"
                                                                    />
                                                                    <ReactTooltip
                                                                        id="add-tooltip"
                                                                        place="bottom"
