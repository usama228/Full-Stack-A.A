      ...
      <div className="freelancer-style1 bdr1 hover-box-shadow row ms-0 align-items-start">
          ...
          <div className="d-lg-flex">
            <div className="thumb w90 position-relative rounded-circle mb15-md">
              <Image
                ...
                src={data?.images[0] || '/path/to/placeholder-image.jpg'} 
                alt="rounded-circle"
              />
            ...
            <div className="details ml20 ml0-md mb15-md">
              <h5 className="title mb-1">{data?.title || 'No available title'}</h5>
              {/* <div className="review mb20">
                <p className="mb-0 fz14 list-inline-item mb5-sm pe-1">
                  <i className="fas fa-star fz10 review-color pr10" />{" "}
                  <span className="dark-color">{data?.rating || 0}</span> ({data?.reviews || 0} reviews)
              ...
              <p className="text mb-0">{data?.description || "No brief available"}</p>
        ...
        <div className="col-xl-2 px-0">
          <div className="text-lg-center text-xl-end mt-0 mt-lg-2 mt-xl-0">
            ...
            {/* <p className="text mb-0">in {data?.hours || 0} hours</p> */}
          </div>
        </div>
      </div>
    </>
