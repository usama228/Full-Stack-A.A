...
export default function HighestRated17() {
        ...
        <div className="row align-items-center wow fadeInUp">
          ...
          <div className="col-lg-3">
            <div className="text-lg-end mb-2">
              <Link href="/freelancer-1" className="ud-btn2 text-white">
        ...
        <div className="row">
          <div className="col-lg-12">
            <div className="position-relative">
              ...
              <button
                type="button"
                className="prev-btn pre-slide3 unique-8-pre"
              >
                <i className="far fa-chevron-left" />
              </button>
              <button
                type="button"
                className="next-btn next-slide3 unique-8-next"
              >
